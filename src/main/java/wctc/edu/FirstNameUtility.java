...
public class FirstNameUtility {
    ...
    public int encodeFirstName(String firstName, String middleInitial) {
        ...
        char firstNameCode = firstName.charAt(0);
        String firstNameCode2 = Character.toString(firstNameCode);

        if (firstNameCodeMap.containsKey(firstName) && !middleInitial.equals("")) {
            ...
            return firstInitialCodeMap.get(firstName);
        }
        else if (!middleInitial.equals("")) {
            return firstInitialCodeMap.get(firstNameCode2) + middleInitialCodeMap.get(middleInitial);
        }
        else {
            return firstInitialCodeMap.get(firstNameCode2);
        }
